...
### Upgrade time : Upgrade time : halt height - 6830943 (Dec 23rd 2023 around 11:40 UTC) and restart to be co-ordinated by all the validators once we have consensus
...
### We plan to halt the chain at height 6830943 swap the binaries and restart the chain with new binary once the consensus is reached. If not done this may result into app hash error.
...
# Now wait till the halt height 6830943 is reached and please follow the below upgrade steps, 
