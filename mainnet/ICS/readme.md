# Comdex Testnet joining ICS (PSS, sovereign transition) upgrade version - v15.2.0
...
## STEP 2 (Opt in Tx on Provider Chain Before the Spawn Time - xxth November 2024 (xxxxday)  xx:xx  UTC)
